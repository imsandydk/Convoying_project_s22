...
class ScenarioRunner(object):
    ...
    def _run_route(self):
        ...
        if self._args.route:
            ...
            print("sing route: {}".format(single_route))
            # breakpoint()

        # retrieve routes
        print("Retrieving routes from {}".format(routes))
        print("Retrieving scenario from {}".format(scenario_file))
        print("Retrieving single route {}".format(single_route))
        route_configurations = RouteParser.parse_routes_file(routes, scenario_file, single_route)
        print("Retrieved routes = {} ".format(route_configurations))
        print("Retrieved routes length = {} ".format(len(route_configurations)))
        # breakpoint()
        # print("Retrieved routes type = {} ".format(type(route_configurations)))
        # breakpoint()
