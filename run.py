...
def main():
    ...
    if args.convoy == 2:
        ...
        subprocess.run("python3 manual_control.py --convoy 6  & python3 manual_control_1.py --convoy 6 --res 320x240 & python3 manual_control_2.py --convoy 6 --res 320x240 & python3 manual_control_3.py --convoy 6 --res 320x240 & python3 manual_control_4.py --convoy 6", shell=True)
