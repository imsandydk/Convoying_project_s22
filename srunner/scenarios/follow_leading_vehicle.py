...
from srunner.tools import scenario_helper
...
class FollowLeadingVehicle(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        """
        routes = "srunner/data/routes_convoy.xml"
        ...
        print("Route configuration:", route_configurations)
        print("Route Configurations Length:",len(route_configurations))
        print("World:",world)
        traj = route_configurations[0].trajectory
        inter_route = interpolate_trajectory_modified(world,traj)
        print("inter_route:",inter_route[0])
        # breakpoint()
        # self.trajectory_leadVehicle = 
    ...
    def _create_behavior(self):
        ...
        endcondition_part1 = InTriggerDistanceToVehicle(self.other_actors[0],
                                                        ...
                                                        distance=1,
                                                        name="FinalDistance")
        endcondition_part2 = StandStill(self.ego_vehicles[0], name="StandStill", duration=1000)
        endcondition.add_child(endcondition_part1)
        endcondition.add_child(endcondition_part2)
        

        print(InTriggerDistanceToNextIntersection(
            self.other_actors[0], self._other_actor_stop_in_front_intersection))
        print(StopVehicle(self.other_actors[0], self._other_actor_max_brake))
        # print(endcondition)
