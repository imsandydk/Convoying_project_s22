...
# State machine states for the FSM in the function below
FOLLOW_LANE = 0   ##FOLLOW LEAD VEHICLE STATE
DECELERATE_TO_STOP = 1   ## START BREAKING STATE 
STAY_STOPPED = 2   ## CONTINUE TO STAY STOPPED
